    ...
    <div className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 flex min-h-screen flex-col items-center justify-between">
        <div className="flex flex-col min-h-screen pt-20 md:pt-40 relative overflow-hidden">
          <h1 className="text-2xl md:text-4xl lg:text-7xl font-semibold max-w-6xl mx-auto text-center mt-6 relative z-10">
            Automate Cold Calling to find Real Estate Wholesaling Leads
          </h1>
          <p className="text-center mt-6 text-base md:text-xl text-muted dark:text-muted-dark max-w-3xl mx-auto relative z-10">
            The best platform out there to help automate your search for leads.
            Simple as inputting the list of phone numbers to cold call and we
            will do the rest.
          </p>
          ...
          <div className="flex items-center justify-center h-72 py-10">
